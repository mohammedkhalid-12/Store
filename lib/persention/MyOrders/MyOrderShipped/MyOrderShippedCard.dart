...
class MyOrderShippedCard extends StatefulWidget {
  MyOrderShippedCard({Key key}) : super(key: key);

  @override
  _MyOrderShippedCardState createState() => _MyOrderShippedCardState();
}

class _MyOrderShippedCardState extends State<MyOrderShippedCard> {
